python -m run.test \
   ...
   --device 'cuda:0' \
   --batch_size 1\
   --model_ckpt_path '/resource/model/maywell/EXAONE-3.0-7.8B-Instruct-Llamafied/GCU_ISNLP_B/checkpoint-630' \
...
python -m run.test \
    ...
    --device 'cuda:0' \
    --batch_size 1\
    --model_ckpt_path '/resource/model/beomi/Llama-3-Open-Ko-8B/GCU_ISNLP_B/checkpoint-580' \
...
python -m run.test \
    ...
    --device 'cuda:0' \
    --batch_size 1\
    --model_ckpt_path '/resource/model/mistralai/Mistral-Nemo-Instruct-2407/GCU_ISNLP_B/checkpoint-580' \
 ...
 python -m run.test \
     ...
     --device 'cuda:0' \
     --batch_size 1\
     --model_ckpt_path '/resource/model/maywell/EXAONE-3.0-7.8B-Instruct-Llamafied/GCU_ISNLP_B/checkpoint-600' \
