python -m run.test \
   ...
   --device 'cuda:0' \
   --batch_size 1\
   --model_ckpt_path '/resource/model/maywell/EXAONE-3.0-7.8B-Instruct-Llamafied/2024-08-18-10-38/checkpoint-630' \
...
python -m run.test \
    ...
    --device 'cuda:0' \
    --batch_size 1\
    --model_ckpt_path '/resource/model/beomi/Llama-3-Open-Ko-8B/2024-08-07-12-22/checkpoint-580' \
...
python -m run.test \
    ...
    --device 'cuda:0' \
    --batch_size 1\
    --model_ckpt_path '/resource/model/mistralai/Mistral-Nemo-Instruct-2407/2024-08-08-15-15/checkpoint-580' \
 ...
 python -m run.test \
     ...
     --device 'cuda:0' \
     --batch_size 1\
     --model_ckpt_path '/resource/model/maywell/EXAONE-3.0-7.8B-Instruct-Llamafied/2024-08-09-05-51/checkpoint-600' \
